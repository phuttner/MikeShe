...
#           be used for sharing a model including all required filesbut not the entire directory with result files etc.
...
#           - Referenced .m1dx files will also be processed to some extent, also any .mupp, .sqlte and .cs files with the same base name as the .m1dx file will be included.
